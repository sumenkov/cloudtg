...
- Загрузка, скачивание и открытие файлов (включая открытие папки в ОС)
  - локальные копии переиспользуются без дублирования
  - при повторном скачивании запрашивается подтверждение на перезапись
...
- Кнопка **Открыть папку**:
  ...
  - открывает директорию локальной копии, без повторного скачивания.
